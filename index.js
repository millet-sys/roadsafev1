...
// List of Road Safety Tips according to categories below
...
app.post('/getSafetyTip', (req, res) => {
  const randomIndex = Math.floor(Math.random() * roadSafetyTip.length);
  const randomTip = {
    safetytip: roadSafetyTip[randomIndex].safetytip,
    category: roadSafetyTip[randomIndex].category
  };
